...
set mode_mac "MII" ; # Set to "RGMII_1" "RGMII_2" "MII" "RMII" for different modes
...
if {$port == "A"} {
    ...
    set_property -dict {PACKAGE_PIN AC41 IOSTANDARD LVCMOS18} [get_ports {phy_rx_dv}]
    ...
    set_property -dict {PACKAGE_PIN AL42 IOSTANDARD LVCMOS18} [get_ports {phy_tx_clk}]
} elseif {$port == "B"} {
    ...
    set_property -dict {PACKAGE_PIN T35 IOSTANDARD LVCMOS18} [get_ports {phy_rx_dv}]
...
if {$mode_mac == "RGMII_1"} {
    ...
    set_property PULLUP true [get_ports phy_rx_dv];     # MACSIF_SEL1
    set_property PULLDOWN true [get_ports phy_rx_clk];  # MACSIF_SEL0
} elseif {$mode_mac == "MII"} {
    set_property PULLDOWN true [get_ports phy_rx_dv];   # MACSIF_SEL1
